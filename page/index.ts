...
let inputChart = echarts.init(document.getElementById('input-chart') as HTMLDivElement);
let outputChart = echarts.init(document.getElementById('output-chart') as HTMLDivElement);
...
let txtArea = document.getElementById('log-area') as HTMLTextAreaElement
const showError = e => {
...
const mountTemplateOptions = () => {
  ...
  select.addEventListener('change', (e) => {
    editor.setValue(indicators[(<HTMLSelectElement>e.target).value], -1)
    evalScript()
  })
}
