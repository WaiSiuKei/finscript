...
export class MAIndicator extends Indicator {
  constructor() {
    ...
    this.addOutput(new RangeOutputExpr("MA", new MaExpr(new CloseExpr(), M2)));
    this.addOutput(new RangeOutputExpr("MA", new MaExpr(new CloseExpr(), M3)));
    this.addOutput(new RangeOutputExpr("MA", new MaExpr(new CloseExpr(), M4)));
  }
